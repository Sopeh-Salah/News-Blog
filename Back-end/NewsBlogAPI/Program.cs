...
namespace NewsBlogAPI
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<newsBlogDatabase>(opt => { opt.UseSqlServer(builder.Configuration.GetConnectionString("con")); });
            builder.Services.AddIdentity<Admin, IdentityRole>()
                .AddEntityFrameworkStores<newsBlogDatabase>()
